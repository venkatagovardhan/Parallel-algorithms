/**
  * Created by Venkata Govardhan on 12/5/2016.
  */
...
val numbusstations = graph.numVertices
//numbusstations: Long = 3
...
//What are the most important busstations according to PageRank
...
//ranksAndbusstations: org.apache.spark.rdd.RDD[String] = MapPartitionsRDD[286] at map at <console>:44
